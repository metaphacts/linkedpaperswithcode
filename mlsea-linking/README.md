...
Output:
- .../paper-sameas-links.nt --> The owl:sameAs links between the publication entities of LPWC and MLSea.
- .../repository-sameas-links.nt --> The owl:sameAs links between the repository entities of LPWC and MLSea.
- .../dataset-sameas-links.nt --> The owl:sameAs links between the dataset entities of LPWC and MLSea.
